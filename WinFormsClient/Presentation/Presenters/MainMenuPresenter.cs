...
public class MainMenuPresenter : BasePresenter<IMainMenuView, Credential>
{
    ...
    {
        View.OnShowProfile += ShowProfile;
        View.OnShowShop += ShowShop;
        View.OnShowCollection += ShowCollection;
        View.OnShowGame += ShowGame;
        //View.LogOut += LogOut;
    }
    ...
    private void ShowProfile() => Controller.Run<ProfilePresenter, Credential>(_credential);
    ...
    {
        Controller.Run<GamePresenter,Credential>(_credential);
        View.Close();
    }
